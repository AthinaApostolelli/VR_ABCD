...
def roicat_visualize_rois(roicat_dir, roicat_data_name, sessions_to_align):
    ...
    ROIs_aligned = ROICaT_results['ROIs']['ROIs_aligned'].load()
    rois = [rois for rois in ROIs_aligned[protocol_nums[0]:protocol_nums[-1]+1]] 
